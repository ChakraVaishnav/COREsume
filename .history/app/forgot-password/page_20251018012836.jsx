  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      ...
      <div className="bg-white p-8 rounded-xl shadow-lg w-full max-w-md space-y-6">
        <button
          onClick={() => router.back()}
          className="absolute top-20 left-4 flex items-center gap-2 px-4 py-2 bg-white border border-yellow-400 rounded-full shadow hover:bg-yellow-50 hover:text-yellow-600 transition font-semibold text-black"
          style={{
