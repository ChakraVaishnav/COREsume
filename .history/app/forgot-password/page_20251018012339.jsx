...
export default function ForgotPasswordPage() {
  ...
  className="absolute top-100 left-300 flex items-center gap-2 px-4 py-2 bg-white border border-yellow-400 rounded-full shadow hover:bg-yellow-50 hover:text-yellow-600 transition font-semibold text-black"
  style={{
