...
export default function ProfilePage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <Link
  href="/dashboard"
  className="absolute top-10 left-4 flex items-center gap-2 px-4 py-2 bg-white border border-yellow-400 rounded-full shadow hover:bg-yellow-50 hover:text-yellow-600 transition font-semibold text-black"
  style={{
