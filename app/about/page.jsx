  ...
  return (
    <PageLayout title="About Us">
      <div className="space-y-6">
        <p>
          Welcome to Resumint, your trusted partner in creating professional, ATS-friendly resumes. 
        ...
        <p>
          Founded in 2025, Resumint was born from a simple observation: creating a professional resume 
