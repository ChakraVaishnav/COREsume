        ...
        <section className="flex flex-col-reverse lg:flex-row items-center justify-between max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 py-16 sm:py-20 gap-10 sm:gap-14">
          ...
          <div className="w-full lg:w-1/2 space-y-6 text-center lg:text-left">
            ...
            <p className="text-base sm:text-lg text-gray-600 max-w-xl mx-auto lg:mx-0">
              Just fill your info, choose from 2 modern ATS-friendly templates,
          ...
          <div className="w-full lg:w-1/2 flex justify-center">
            <div className="w-60 h-60 sm:w-72 sm:h-72 md:w-80 md:h-80 bg-gradient-to-br from-yellow-400 to-yellow-300 rounded-[2rem] shadow-2xl flex items-center justify-center text-white text-9xl font-bold select-none">
              +
            </div>
          </div>
        </section>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-10 mt-8 sm:mt-10">
            ...
            <div className="p-6 sm:p-8 bg-white rounded-xl shadow hover:shadow-lg transition-all duration-300">
              <div className="text-yellow-400 text-4xl sm:text-5xl mb-4">🖋️</div>
              <h4 className="text-xl sm:text-2xl font-bold mb-2">2 Beautiful Templates</h4>
              <p className="text-gray-600 text-sm sm:text-base">
                Select from two elegant and modern resume designs that pass ATS
            ...
            <div className="p-6 sm:p-8 bg-white rounded-xl shadow hover:shadow-lg transition-all duration-300">
              ...
              <h4 className="text-xl sm:text-2xl font-bold mb-2">Secure & Simple</h4>
              <p className="text-gray-600 text-sm sm:text-base">
                Integrated Razorpay checkout with secure payments, and zero
                hassle. Build, preview, pay, download.
              </p>
            </div>
          </div>
        </section>
